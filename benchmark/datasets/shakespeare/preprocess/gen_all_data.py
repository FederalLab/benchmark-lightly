# @Author            : FederalLab
# @Date              : 2021-09-26 00:33:21
# @Last Modified by  : Chen Dengsheng
# @Last Modified time: 2021-09-26 00:33:21
...
users_and_plays_path = os.path.join(parent_path, 'data', 'raw_data',
                                    'users_and_plays.json')
txt_dir = os.path.join(parent_path, 'data', 'raw_data',
