# @Author            : FederalLab
# @Date              : 2021-09-26 00:33:28
# @Last Modified by  : Chen Dengsheng
# @Last Modified time: 2021-09-26 00:33:28
...
def parse_data_in(data_dir, users_and_plays_path, raw=False):
    """returns dictionary with keys: users, num_samples, user_data raw := bool
    representing whether to include raw text in all_data if raw is True, then
    user_data key removes users with no data."""
