...
# name of the dataset, equivalent to directory name
NAME="sent140"
# -s tag, iid or niid
SAMPLE="na"
# --iu tag, # of users if iid sampling
IUSER=""
# --sf tag, fraction of data to sample
SFRAC=""
# -k tag, minimum allowable # of samples per user
MINSAMPLES="na"
# -t tag, user or sample
TRAIN="na"
# --tf tag, fraction of data in training set
TFRAC=""
# --smplseed, seed specified for sampling of data
SAMPLING_SEED=""
# --spltseed, seed specified for train/test data split
SPLIT_SEED=""
# --nochecksum, disable creation of MD5 checksum file after data gen
NO_CHECKSUM=""
# --verify <fname>, check if JSON files' MD5 matches given digest
VERIFICATION_FILE=""
